...
//Lỗi liên quan tới đường dẫn( VD: nếu update phòng ban ko có thì sẽ báo lỗi này số phòng abn sẽ ở cuối đường dẫn)
...
//    Hàm xử lí tất cả lỗi(sẽ đưa ra 1 message chung chung )(nếu mà có 1000 lỗi mình chỉ xuwr lí đc 100 lỗi thì các lỗi còn lại sẽ đưa ra thông báo này )
